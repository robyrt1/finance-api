    ...
    public class CustomExceptionFilter : IExceptionFilter
    {
        public void OnException(ExceptionContext context)
        {
            ...
            else
            {
                ...
                context.Result = new ObjectResult(new { statusCode = HttpStatusCode.InternalServerError, error = "An unexpected error occurred.", date = DateTime.Now, data = context.HttpContext.Response.Body.ToString() })
                {
